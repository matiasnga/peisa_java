...
/* INSERT QUERY NO: 8 */
INSERT INTO mo(id, codigo, descripcion, precio) VALUES
...
/* INSERT QUERY NO: 11 */
INSERT INTO mediosdepago(id, descripcion) VALUES
(1, 'Efectivo'),
(2, 'Transferencia'),
(3, 'Codigo QR');

/* INSERT QUERY NO: 12 */
ALTER TABLE orden ADD FOREIGN KEY (mediodepago_id) references mediosdepago(id); 
UPDATE orden SET mediodepago_id = 2 where id in (1);
...
VALUES
(
272, 90000077, 'PRESOSTATO DE AGUA G1/8 3T DONNA/XP', 1, 21.46, 21.46, 1
);
